...
const Slider = (props) => {
  ...
  return (
    <div className="slider-container">
      <div className="inline-flex items-center justify-around w-full slider">
        <input
          ref={rangeRef}
          className="w-10/12 range-slider"
          type="range"
          step={step}
          min={min}
          max={max}
          ...
          style={styleInput}
        />
        <span className="w-1/12 range-slider-value">{progressValue}</span>
      </div>
    </div>
  )
}
