          ...
          <div className="flex flex-wrap">
            <div className="w-full px-4 lg:w-6/12">
              ...
              <div className="mt-6">
                ...
                >
                  <svg
                    className="flex w-4 h-4 fill-current bi bi-twitter"
                    viewBox="0 0 16 16"
                  >
                ...
                >
                  <svg
                    className="flex w-4 h-4 fill-current bi bi-facebook"
                    viewBox="0 0 16 16"
                  >
                ...
                <button
                  className="items-center justify-center w-10 h-10 p-3 mr-2 font-normal bg-white rounded-full shadow-lg outline-none align-center focus:outline-none"
                  type="button"
                >
                  <svg
                    className="flex w-4 h-4 fill-current bi bi-instagram"
                    viewBox="0 0 16 16"
                  >
                ...
                >
                  <svg
                    className="flex w-4 h-4 fill-current bi bi-github"
                    viewBox="0 0 16 16"
                  >
