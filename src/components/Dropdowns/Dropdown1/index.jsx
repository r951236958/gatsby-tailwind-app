...
function Dropdown({
  ...
  const createOption = o => {
    ...
    return (
      <OptionTag
        key={o.id}
        className="flex items-center px-3 py-3 text-sm font-light cursor-pointer hover:bg-gray-200 focus:outline-none"
        href={o.link}
      >
  ...
  const Banner = header ? (
    <div className="px-3 py-3 border-b border-gray-100">{header}</div>
  ) : null
